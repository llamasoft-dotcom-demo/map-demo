...
$(function () {
    ...
    //loads events after list are generated
    ...
    //need to be loaded after initPageBuild
    function loadEvents() {
        $codeItem = $(".code-item");
        $cityItem = $(".city-item");
        ...
        $codeItem.click(function (e) {
            ...
            updateMyAirports(myAirports_arr)
        ...
        $(".airport-finder_btn").click(function (e) {
            e.preventDefault();
...
//generates my-airports list
//loads delete_btn event
//calls to update the map markers
function updateMyAirports(data) {
    ...
    updateMarkers();
    $(".remove-airport_btn").click(function (e) {
        e.preventDefault();
        $this = $(this);
        $code = $this.attr("data-code");
...
//removes airport from the array
//calls to update the map markers
...
//updates markers on map with array
...
//used to clear markers in map
//used add markers to map
function setMapOnAll(map_obj) {
    for (var i = 0; i < markers_arr.length; i++) {
        markers_arr[i].setMap(map_obj);
    }
}

//clears map's markers
